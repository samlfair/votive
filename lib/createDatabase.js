  ...
  return {
    ...
    target: {
      ...
      create: /** @type {{get: SQLiteTargetCreate}} */ (/** @type {unknown} */ (database.prepare(`
        INSERT OR IGNORE INTO destinations (path, dir, extension, stale, abstract)
        VALUES (?, ?, ?, 1, ?)
        RETURNING *
      `))),
      ...
      get: /** @type {{get: SQLiteTargetGet}} */ (/** @type {unknown} */ (database.prepare(`
        ...
        SELECT destination.path, destination.dir, destination.extension, destination.abstract,
